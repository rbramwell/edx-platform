...
(function(requirejs) {
    ...
    testFiles = [
        ...
        'discussions/js/spec/discussion_board_factory_spec.js',
        'discussions/js/spec/discussion_profile_page_factory_spec.js',
        'discussions/js/spec/discussion_board_view_spec.js',
        'discussions/js/spec/views/discussion_user_profile_view_spec.js',
